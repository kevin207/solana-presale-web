      ...
      <div className="flex flex-col lg:flex-row w-full max-w-7xl gap-5 justify-center items-center px-5 py-20">
        <div className="flex flex-col w-full h-fit">
          ...
          <p className="text-accent font-light text-base selection:bg-main selection:text-accent">
            ...
            accusamus cupiditate quae placeat nulla alias. A obcaecati est,
            nihil ducimus quia labore omnis, accusamus molestias eveniet error
            suscipit sint inventore! Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Atque error sit sunt doloribus similique quae
            sequi aperiam totam? Eveniet sapiente non mollitia ducimus eligendi
            ut hic veniam, molestias obcaecati ipsum!
          </p>
